...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/long_cat.png", "start": 0, "end": 183}, {"filename": "/assets/round_cat.png", "start": 183, "end": 500}], "remote_package_size": 500});

  })();

// end include: /tmp/tmpbk5xjvtn.js
// include: /tmp/tmpw6hip6zt.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpw6hip6zt.js
// include: /tmp/tmpk4e2krvo.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpk4e2krvo.js
...
var ASM_CONSTS = {
  129504: () => { if (document.fullscreenElement) return 1; },  
 129550: () => { return document.getElementById('canvas').width; },  
 129602: () => { return parseInt(document.getElementById('canvas').style.width); },  
 129670: () => { document.exitFullscreen(); },  
 129697: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 129770: () => { if (document.fullscreenElement) return 1; },  
 129816: () => { return document.getElementById('canvas').width; },  
 129868: () => { return screen.width; },  
 129893: () => { document.exitFullscreen(); },  
 129920: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 130053: () => { return window.innerWidth; },  
 130079: () => { return window.innerHeight; },  
 130106: () => { if (document.fullscreenElement) return 1; },  
 130152: () => { return document.getElementById('canvas').width; },  
 130204: () => { return parseInt(document.getElementById('canvas').style.width); },  
 130272: () => { if (document.fullscreenElement) return 1; },  
 130318: () => { return document.getElementById('canvas').width; },  
 130370: () => { return screen.width; },  
 130395: () => { return window.innerWidth; },  
 130421: () => { return window.innerHeight; },  
 130448: () => { if (document.fullscreenElement) return 1; },  
 130494: () => { return document.getElementById('canvas').width; },  
 130546: () => { return screen.width; },  
 130571: () => { document.exitFullscreen(); },  
 130598: () => { if (document.fullscreenElement) return 1; },  
 130644: () => { return document.getElementById('canvas').width; },  
 130696: () => { return parseInt(document.getElementById('canvas').style.width); },  
 130764: () => { document.exitFullscreen(); },  
 130791: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 130849: () => { return screen.width; },  
 130874: () => { return screen.height; },  
 130900: () => { return window.screenX; },  
 130927: () => { return window.screenY; },  
 130954: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 131007: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 131078: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 131135: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 131391: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 131462: () => { if (document.fullscreenElement) return 1; },  
 131508: () => { return window.innerWidth; },  
 131534: () => { return window.innerHeight; },  
 131561: () => { if (document.pointerLockElement) return 1; }
};
...
var dynCall_viiiiijii = Module['dynCall_viiiiijii'] = createExportWrapper('dynCall_viiiiijii', 9);
